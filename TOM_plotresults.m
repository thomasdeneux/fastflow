...
% for k = 1:4
%     anglesc_syl{k}=y.anglesc_syl{k};mult_anglesc_syl{k}=(y.anglesc_syl{k}~=0);
...
% for k = 1:4
%     avrg.anglesc_syl{k}=anglesc_syl{k}./(mult_anglesc_syl{k}+isinf(ones(size(mult_anglesc_syl{k}))./mult_anglesc_syl{k}));
%     avrg.speedsc_syl{k}=speedsc_syl{k}./(mult_speedsc_syl{k}+isinf(ones(size(mult_speedsc_syl{k}))./mult_speedsc_syl{k}));
%     avrg.angletg_syl{k}=angletg_syl{k}./(mult_angletg_syl{k}+isinf(ones(size(mult_angletg_syl{k}))./mult_angletg_syl{k}));
%     avrg.speedtg_syl{k}=speedtg_syl{k}./(mult_speedtg_syl{k}+isinf(ones(size(mult_speedtg_syl{k}))./mult_speedtg_syl{k}));
% end
...
hold
y=plot(compute_speed(avrg.anglesc_orig,'angle')*0.8);set(y,'color','b','Linewidth',2,'Linestyle','-')
grid
