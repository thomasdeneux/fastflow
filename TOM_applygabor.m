function res = TOM_applygabor(e,nbdata,aff,filter_struct)
%[anglesc,angl,coef]=TOM_applygabor(e,nbdata,aff,filter_struct)
%
%INPUTS (all are optional):
%e : data to analyse
%nbdata: number of the expermient to analyse, i.e. the image to analyse
%will be "e(nbdata).data"
...
if exist('e')==0, %exist('img1200')==0, %1==1, %charger donnees
    nomdata='fake01_th092_st100_jit000' ;% th:87 90 92 97  st:025 050 100 200 300 400
    disp(['loading e from:', nomdata,'.mat ']) ; % fortesttrue.mat') ;
    %load fortesttrue.mat %load fortestsimul
    eval(['load ',nomdata,'.mat ;']) ;  
    eval(['e= v1',nomdata,' ;']) ;


end
if exist('nbdata')==0, %exist('img1200')==0, %1==1, %charger donnees
    nbdata=1 ; % numero de l'experience
end

img1200b=e(nbdata).data ;
img1200b=filtx2(img1200b,15,'hm');
